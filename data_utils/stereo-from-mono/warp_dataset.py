...
class WarpDataset(BaseDataset):
    ...
    def prepare_sizes(self, inputs):
        ...
        print(f"targe h: {target_height}, target w: {target_width}")
    ...
    def prepare_sizes_background(self, inputs):
    ...
    def __getitem__(self, idx):
        ...
        try :
            ...
            return inputs
        left_image, background_image, left_image_name = self.load_images(idx, do_flip=do_flip)
        ...
        # resize and/or crop background
        # inputs = self.prepare_sizes_background(inputs)
